  ...
  render(){
    return(
      <div className="project-details">
        ...
        <p>To graduate, I had to create a project that could be anything I wanted. Strugging to find something I was interested in, I started playing <a href="http://2048game.com">2048</a> on 
