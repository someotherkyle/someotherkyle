      ...
      <div className='about'>
        ...
        <div className='row about-text'>
          ...
          <div className='col-xs-10 col-sm-10'>
            ...
            <p>I naively started Flatiron 'looking down on' web development, placing compiled languages on some sort of pedestal. I wanted to transition quickly to C++ and pursue extreme optimization and performance by getting 'close to the metal' and working on complex code bases to create the next big game or must have program. I've since realized how silly this mentality was as things have been transitioning more and more to the cloud and web based applications are only growing in their intricacy. C++ will always have a special place in my heart and I will continue to study it but JavaScript has piqued my interest for the immediate future.</p>
